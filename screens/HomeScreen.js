...
const HomeScreen = () => {
  ...
  return (
    <Container style={{ backgroundColor: theme.background }}>
      <Header>
        <ProfileImage source={require('../assets/me.jpg')} />
        <WelcomeContainer>
          <WelcomeText>Welcome back,</WelcomeText>
          <UserName>Isabel Kwarteng</UserName>
        </WelcomeContainer>
      ...
      <Actions>
        <ActionButton>
          <ActionIconCircle>
            <ActionIcon source={require('../assets/sent.png')} />
          </ActionIconCircle>
          <ActionText>Sent</ActionText>
        </ActionButton>
        <ActionButton>
          <ActionIconCircle>
            <ActionIcon source={require('../assets/received.png')}/>
          </ActionIconCircle>
      ...
      <Transactions>
        ...
        <TransactionList>
          ...
          <TransactionItem>
            <TransactionIconCircle>
              <TransactionIcon source={require('../assets/mt.png')} />
            </TransactionIconCircle>
            <TransactionDetails>
          ...
          <TransactionItem>
            <TransactionIconCircle>
              <TransactionIcon source={require('../assets/gs.jpeg')} />
            </TransactionIconCircle>
            <TransactionDetails>
